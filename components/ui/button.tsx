...
export function Button({ 
  ...
  const variants = {
    ...
    destructive: "bg-red-500 text-white hover:bg-red-600 focus:ring-red-500/50 shadow-sm",
    secondary: "bg-gray-100 text-text/80 hover:bg-gray-200 focus:ring-gray-200",
    ghost: "bg-transparent text-accent hover:bg-accent/10 focus:ring-accent/20"
  };
